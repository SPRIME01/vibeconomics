from typing import Annotated, Generator, Any, Callable # Added Callable
from fastapi import Depends

from app.service_layer.unit_of_work import AbstractUnitOfWork
from app.adapters.uow_sqlmodel import SqlModelUnitOfWork
from app.service_layer.message_bus import AbstractMessageBus # Removed EventT as it's not used here generically
...
def get_db_session_factory() -> Callable[[], Any]: # Return type is a callable that returns a session-like Any
    """
...
message_bus_instance: AbstractMessageBus[DomainEvent] = InMemoryMessageBus[DomainEvent]()
