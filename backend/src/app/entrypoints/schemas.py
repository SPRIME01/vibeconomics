...
from sqlmodel import (
    SQLModel,
)  # SQLModel is used as a base for some of these DTOs in the original file


# Properties to return via API, id is always required
class UserPublic(
    SQLModel
):  # Kept SQLModel as base from original, can be changed to Pydantic BaseModel if no SQLModel features are used
    id: uuid.UUID
    email: EmailStr
    is_active: bool
    is_superuser: bool
